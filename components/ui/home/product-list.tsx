...
export default function ProductList() {
    return (
        <ul className="flex flex-col gap-6 md:gap-8">
            <li>
                <ProductCard className="bg-primary text-white relative lg:max-h-[560] lg:flex-row lg:items-center lg:gap-16 border border-red-700">
            ...
            <li>
                <ProductCard className="relative w-full h-auto max-h-80 items-start p-0">
                    <ResponsiveImage
                        ...
                        alt="ZX7 speaker"
                    />
                    <ProductContent className="w-full absolute p-6 lg:w-1/2 lg:p-16 lg:justify-center">
