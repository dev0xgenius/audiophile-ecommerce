        ...
        <ul className="grid gap-6">
            <li>
                <ProductCard className="bg-primary text-white">
                    <div className="relative w-full flex justify-center items-center m-auto">
                        <ProductImage
                            src={SpeakerZX9Image}
                            className="w-[172.2] h-[207]"
                            alt=""
                        />
                        {/* TODO: Fix circle borders */}
                        <div className="border size-[588] rounded-full border-accent absolute" />
                        <div className="border size-80 rounded-full border-accent absolute" />
                        <div className="border size-[279px] rounded-full border-accent absolute" />
                    </div>
                    <ProductContent>
                        <ProductTitle className="px-5 pt-4">
                            ZX9 SPEAKER
                        </ProductTitle>
                        <ProductDescription>
            ...
            <li>
                <ProductCard className="relative items-start p-0">
                    ...
                    <ProductContent className="absolute p-6">
                        <ProductTitle className="text-3xl">
                            ZX7 SPEAKER
                        </ProductTitle>
            ...
            <li>
                <ProductCard className="p-0 shadow-none border-none">
                    ...
                    />
                    <ProductContent className="flex items-start rounded-2xl gap-8 p-6 py-10 bg-accent-foreground">
                        <ProductTitle className="text-3xl">
                            YX1 EARPHONES
                        </ProductTitle>
                        <ProductAction variant={"outline"} />
