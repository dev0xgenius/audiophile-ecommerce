...
export default function AboutInfo() {
    return (
        <Card className="container m-auto p-0 shadow-none border-0 text-center mt-20 md:mt-[120] gap-8 md:gap-16 lg:flex-row-reverse lg:text-left lg:items-center lg:gap-24">
