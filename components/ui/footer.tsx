        ...
        <footer className="flex flex-col gap-[120px]">
            ...
            <div className="w-full bg-darker">
                <div className="container xl:max-w-[1110]  m-auto flex flex-col gap-12 items-center md:items-start py-10 relative">
                    ...
                    <div className="w-full flex flex-col gap-4 items-center justify-center md:flex-row md:justify-between">
                        <span className="font-semibold text-accent-foreground block w-max">
                            Copyright 2021. All Rights Reserved.
                        </span>
                        <div className="flex gap-4 items-center">
                            <a
                                href="#"
                                className="hover:opacity-80 focus-visible:ring-2 focus-visible:ring-ring rounded-md transition-opacity outline-none"
                            >
                                <Image
                                    src={facebookIcon}
                                    width={24}
